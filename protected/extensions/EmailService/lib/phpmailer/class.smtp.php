...
class SMTP {
  ...
  private $data_command_rply; //the reply the server sent to us for DATA
  /**
   * @return string
   */
   ...
   * If tval is not specified the default is 60 seconds to
